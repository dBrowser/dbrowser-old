...
/**
 * @typedef {import('../dwebx/daemon').DaemonHyperdrive} DaemonHyperdrive
 *
...
var datPath/** @type string - path to the dwebx folder */
...
export function setup (opts) {
  ...
  datPath = path.join(opts.userDataPath, 'DWebX')
...
export async function getMeta (key, {noDefault} = {noDefault: false}) {
  ...
  // massage some values
  meta.url = `dweb://${meta.dnsName || meta.key}/`
  delete meta.dnsName
