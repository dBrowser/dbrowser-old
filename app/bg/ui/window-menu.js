...
export function buildWindowMenu (opts = {}) {
  ...
  const isDriveSite = url.startsWith('dweb://')
  ...
  var darwinMenu = {
    ...
    submenu: [
      ...
      { type: 'separator' },
      { label: 'Hide DBrowserX', accelerator: 'Cmd+H', role: 'hide' },
  ...
  var fileMenu = {
    ...
    submenu: [
      ...
      //         drive: url.startsWith('dweb:') ? url : undefined
      //       })
      //       let drive = await dweb.drives.getOrLoadDrive(res.origin)
  ...
  var driveMenu = {
    ...
    submenu: [
      ...
      {type: 'separator'},
      {
        ...
        enabled: !!isDriveSite,
        async click (item) {
          if (win) runDrivePropertiesFlow(win, dweb.drives.fromURLToKey(url))
        }
      }
    ]
  }
  ...
  var helpMenu = {
    ...
    submenu: [
      ...
      },
      {
        ...
        click: function (item) {
          if (win) tabManager.create(win, 'https://dbrowserx.dev/', {setActive: true})
        }
      },
      {type: 'separator'},
      {
