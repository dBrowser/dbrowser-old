...
export const ANALYTICS_SERVER = 'analytics.dbrowser.com'
export const ANALYTICS_CHECKIN_INTERVAL = ms('6h')

// dwebfs FS file paths
export const PATHS = {
  BOOKMARKS: '/bookmarks'
}

// dwebfs trash management
...
export const HYPERDRIVE_URL_REGEX = /^(?:(hyper|dweb):\/\/)?([0-9a-f]{64})/i
...
// dweb settings
export const DAT_SWARM_PORT = 6620
