/* globals dbrowserx DatArchive localStorage */
...
const STEPS = [
  {
    ...
    description: 'DBrowserX is a browser for exploring and building the peer-to-peer Web.',
    content: () => yo`
      <div>
        ...
        <p>
          <label class="toggle">
            <input checked=${defaultProtocolSettings.dwebx} type="checkbox" onchange=${onToggleDefaultBrowser} />
            <div class="switch"></div>
            <span class="text">
              Set DBrowserX as the default browser for dwebx:// URLs
            </span>
          ...
          <div class="onboarding-hint ${isHintHidden ? 'hidden' : ''}">
            dwebx:// is a peer-to-peer protocol that DBrowserX uses to host websites
          </div>
        </p>
      </div>`,
    color: 'blue',
    onLeave: async () => {
      if (defaultProtocolSettings.dwebx) {
        await dbrowserx.browser.setAsDefaultProtocolClient('dwebx')
      } else {
        await dbrowserx.browser.removeAsDefaultProtocolClient('dwebx')
      }
    }
  },
  {
      ...
      <p>
        ...
        <a href="dwebx://explore.dbrowser.com" class="module" target="_blank">
          ...
          <span>
            ...
            <p>
              Explore websites, apps, and tools built with DBrowserX and dwebx://.
            </p>
          </span>
        </a>
        ...
        <a href="dwebx://dbrowser.com/docs" class="module" target="_blank">
          ...
          <span>
            ...
            <p>
              Explore DBrowserX${"'"}s documentation and tutorials.
            </p>
          </span>
        </a>
      </p>`,
...
function onToggleDefaultBrowser (e) {
  e.preventDefault()
  defaultProtocolSettings.dwebx = !defaultProtocolSettings.dwebx
  update()
}
