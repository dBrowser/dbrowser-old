...
export class BeakerEditCoverPhoto extends BasePopup {
  ...
  static async runFlow (profiles) {
    ...
    var drive = dbrowserx.ddrive.drive(profile.url)
  ...
  static destroy () {
    return BasePopup.destroy('dbrowserx-edit-cover-photo')
  }
...
customElements.define('dbrowserx-edit-cover-photo', BeakerEditCoverPhoto)