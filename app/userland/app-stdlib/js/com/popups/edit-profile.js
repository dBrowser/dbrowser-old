...
export class BeakerEditProfile extends BasePopup {
  ...
  static async runFlow (profiles) {
    ...
    await dbrowserx.ddrive.drive(profile.url).configure(newValues)
    return profiles.me()
  }

  static destroy () {
    return BasePopup.destroy('dbrowserx-edit-profile')
  }
...
customElements.define('dbrowserx-edit-profile', BeakerEditProfile)