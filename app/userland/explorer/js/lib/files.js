...
async function doCopyOrMove ({sourceItem, targetFolder}, op) {
  ...
  var sourceDrive = dbrowser.dwebfs.drive(sourceItemParsed.hostname)
  let targetFolderParsed = new URL(targetFolder)
  var targetDrive = dbrowser.dwebfs.drive(targetFolderParsed.hostname)
