...
async function doCopyOrMove ({sourceItem, targetFolder}, op) {
  ...
  var sourceDrive = dbrowserx.ddrive.drive(sourceItemParsed.hostname)
  let targetFolderParsed = new URL(targetFolder)
  var targetDrive = dbrowserx.ddrive.drive(targetFolderParsed.hostname)
