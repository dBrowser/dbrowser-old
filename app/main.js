...
import dweb from './bg/dweb/index'
...
import * as beakerProtocol from './bg/protocols/dbrowserx'
import * as assetProtocol from './bg/protocols/asset'
import * as hyperProtocol from './bg/protocols/dweb'
import * as datProtocol from './bg/protocols/dwebx'
...
protocol.registerSchemesAsPrivileged([
  ...
  {scheme: 'dbrowserx', privileges: {standard: true, secure: true, allowServiceWorkers: true, supportFetchAPI: true, corsEnabled: true}}
])
...
app.on('ready', async function () {
  ...
  await logger.setup(join(commonOpts.userDataPath, 'dbrowserx.log'))
