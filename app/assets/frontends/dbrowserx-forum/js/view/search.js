    ...
    return html`
      ...
      <div class="layout right-col">
        <main>
          ...
          <dbrowserx-search-results loadable .user=${this.user} drive-type=${this.driveType || ''} query=${this.query || ''}></dbrowserx-search-results>
        </main>
        <nav>
...
customElements.define('dbrowserx-search-view', SearchView)
