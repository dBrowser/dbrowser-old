...
export class CommentsThread extends LitElement {
  ...
  async onClickToggleReply (e, url) {
    ...
    if (this.activeReplies[url]) {
      this.shadowRoot.querySelector(`dbrowserx-comment-composer[parent="${url}"]`).focus()
    }
  }
...
customElements.define('dbrowserx-comments-thread', CommentsThread)